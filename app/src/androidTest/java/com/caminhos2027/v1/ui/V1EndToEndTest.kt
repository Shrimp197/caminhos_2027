...
class V1EndToEndTest {
    ...
    fun testVerticalSliceFromPlanToApoiDetailAndDecision() {
        ...
        assertTrue(
            ...
            waitForVisibleText("Próximos 10 km", 30_000)
        )
        ...
        assertTrue(
            "APOI navigation/location action did not appear",
            waitForAnyVisibleText("Navegar a pé", "Localização exata", timeoutMs = 30_000)
        )
        ...
        assertTrue(
            ...
            waitForVisibleText("Informação para decidir", 30_000)
        )
    ...
    private fun prepareAndStartSr() {
        ...
        assertTrue("Breaks enabled state did not appear", waitForVisibleText("Ativadas", 30_000))
