...
# Support filter behavior is covered by its dedicated regression; release validation checks
# only that the canonical control and canonical handler/render pipeline remain present.
