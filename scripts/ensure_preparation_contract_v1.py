...
if 'id="cpRouteSelect"' not in html:
    if marker not in html: raise SystemExit('Canonical legacy source marker not found')
    html=html.replace(marker,marker+compat,1)
filters='''<div id="supportFilters"><input type="checkbox" data-filter="all" checked><input type="checkbox" data-filter="overnight"><input type="checkbox" data-filter="water"><input type="checkbox" data-filter="shower"><input type="checkbox" data-filter="health"><input type="checkbox" data-filter="fire"><input type="checkbox" data-filter="temporary"><input type="checkbox" data-filter="other"></div>'''
html=html.replace('<div id="supportFilters"></div>',filters,1)
...
if 'id="cp-prep-v1-contract"' not in html: html=html.replace('</body>',shim+'\n</body>',1)
